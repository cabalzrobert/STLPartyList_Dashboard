...
namespace Comm.Common.Extensions
{
    public static class StringExt
    {
        ...
        {
            return (str.IsEmpty()) ? "" : Regex.Replace(Regex.Replace(str, "<(.*)>", ""), "<(.*)>(.*)</(.*)>", "");
        }
        public static String URLEncode(this String str)
        {
            return (str.IsEmpty()) ? "" : WebUtility.UrlEncode(str);
        }
        public static String URLDecode(this String str)
        {
            return (str.IsEmpty()) ? "" : WebUtility.UrlDecode(str);
        }
        public static String HTMLEncode(this String str)
        {
            return (str.IsEmpty()) ? "" : WebUtility.HtmlEncode(str);
        }
        public static String HTMLDecode(this String str)
        {
            return (str.IsEmpty()) ? "" : WebUtility.HtmlDecode(str);
        }
    }
}